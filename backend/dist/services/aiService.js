...
class AIService {
    ...
    async predictIngredientShortages() {
        try {
            ...
            console.warn('[AIService] predictIngredientShortages failed, returning demo data:', error.message);
    ...
    async recommendReorderQuantities() {
        try {
            ...
            console.warn('[AIService] recommendReorderQuantities failed, returning demo data:', error.message);
    ...
    async suggestMenuPricing() {
        try {
            ...
            console.warn('[AIService] suggestMenuPricing failed, returning demo data:', error.message);
    ...
    async estimateFoodPrepTime(itemIds) {
        try {
            ...
            console.warn('[AIService] estimateFoodPrepTime failed, returning demo data:', error.message);
            return {
                itemsCount: itemIds?.length || 1,
    ...
    async analyzeIngredientWaste() {
        try {
            ...
            console.warn('[AIService] analyzeIngredientWaste failed, returning demo data:', error.message);
